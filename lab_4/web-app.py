...
class Plotting:
    def plot_data(self, sensor):
        ...
        Save the plot img in static folder
        """
        mysql = mySQL()
...
class mySQL:
    ...
    def create_connection(self):
        ...
        """
        self.conn = mysql.connector.connect(host='localhost', database='pisensedb', user='root', password='')
...
def main():
    ...
    #mysql.insert_update("sensor_readings3", [1.0,2.2,3.3,4.4])

    #Plot data and store in static folder
    plotting = Plotting()
    plotting.plot_data("sensor_readings1")
    plotting.plot_data("sensor_readings2")
    plotting.plot_data("sensor_readings3")
