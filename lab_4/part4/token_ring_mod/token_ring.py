...
def main(): 
    ...
    my_server = token_server(HOST_IP, PORT, user_answer)
    ...
    if user_answer == True: 
        ...
        my_server.packet_ring_handler(token_packet, 0)
    ...
    while True: 
        ...
        decoded_packet = my_server.packet_decoder(packet)
        seq_num = my_server.check_seq_number(decoded_packet)
        my_server.packet_ring_handler(decoded_packet, seq_num)
        #start listener
